...
export class FlightService {
  ...
  searchFlights(startPlace: string, endPlace: String, startDateString: string, endDateString: string, quantity : string):Observable<any> {
    return this.http.get(this.apiServerUrl + '/flight/search?startPlace=' + startPlace + '&endPlace=' + endPlace + '&startDate=' + startDateString + '&endDate=' + endDateString + '&quantity=' + quantity,{headers: this.headers, responseType: 'text'})
  }
