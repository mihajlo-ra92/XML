...
const (
	...
	AuthService_AuthDefineCustomPrice_FullMethodName              = "/user.AuthService/AuthDefineCustomPrice"
	AuthService_AuthGetAccommodationByHostId_FullMethodName       = "/user.AuthService/AuthGetAccommodationByHostId"
	AuthService_AuthGetBookingsByAccommodationId_FullMethodName   = "/user.AuthService/AuthGetBookingsByAccommodationId"
	AuthService_AuthCreateRating_FullMethodName                   = "/user.AuthService/AuthCreateRating"
	AuthService_AuthDeleteRating_FullMethodName                   = "/user.AuthService/AuthDeleteRating"
	AuthService_AuthGetUserRatingByAccommodationId_FullMethodName = "/user.AuthService/AuthGetUserRatingByAccommodationId"
	AuthService_AuthGetUserRatingByHostId_FullMethodName          = "/user.AuthService/AuthGetUserRatingByHostId"
	AuthService_AuthGetUser_FullMethodName                        = "/user.AuthService/AuthGetUser"
)
...
type AuthServiceClient interface {
	...
	AuthGetUser(ctx context.Context, in *AuthGetUserRequest, opts ...grpc.CallOption) (*AuthGetUserResponse, error)
}
...
func (c *authServiceClient) AuthDefineCustomPrice(ctx context.Context, in *AuthDefineCustomPriceRequest, opts ...grpc.CallOption) (*AuthDefineCustomPriceResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_AuthDefineCustomPrice_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) AuthGetAccommodationByHostId(ctx context.Context, in *AuthGetAccommodationsByHostIdRequest, opts ...grpc.CallOption) (*AuthGetAccommodationsByHostIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_AuthGetAccommodationByHostId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) AuthGetBookingsByAccommodationId(ctx context.Context, in *AuthGetBookingsByAccommodationIdRequest, opts ...grpc.CallOption) (*AuthGetBookingsByAccommodationIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_AuthGetBookingsByAccommodationId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) AuthCreateRating(ctx context.Context, in *AuthCreateRatingRequest, opts ...grpc.CallOption) (*AuthCreateRatingResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_AuthCreateRating_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) AuthDeleteRating(ctx context.Context, in *AuthDeleteRatingRequest, opts ...grpc.CallOption) (*AuthDeleteRatingResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_AuthDeleteRating_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) AuthGetUserRatingByAccommodationId(ctx context.Context, in *AuthGetUserRatingByAccommodationIdRequest, opts ...grpc.CallOption) (*AuthGetUserRatingByAccommodationIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_AuthGetUserRatingByAccommodationId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) AuthGetUserRatingByHostId(ctx context.Context, in *AuthGetUserRatingByHostIdRequest, opts ...grpc.CallOption) (*AuthGetUserRatingByHostIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_AuthGetUserRatingByHostId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) AuthGetUser(ctx context.Context, in *AuthGetUserRequest, opts ...grpc.CallOption) (*AuthGetUserResponse, error) {
	out := new(AuthGetUserResponse)
	err := c.cc.Invoke(ctx, AuthService_AuthGetUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	AuthGetUser(context.Context, *AuthGetUserRequest) (*AuthGetUserResponse, error)
...
func (UnimplementedAuthServiceServer) AuthGetUser(context.Context, *AuthGetUserRequest) (*AuthGetUserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AuthGetUser not implemented")
}
...
func _AuthService_AuthDefineCustomPrice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_AuthDefineCustomPrice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthService_AuthGetAccommodationByHostId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_AuthGetAccommodationByHostId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthService_AuthGetBookingsByAccommodationId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_AuthGetBookingsByAccommodationId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthService_AuthCreateRating_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_AuthCreateRating_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthService_AuthDeleteRating_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_AuthDeleteRating_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthService_AuthGetUserRatingByAccommodationId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_AuthGetUserRatingByAccommodationId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthService_AuthGetUserRatingByHostId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_AuthGetUserRatingByHostId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AuthService_AuthGetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AuthGetUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).AuthGetUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_AuthGetUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).AuthGetUser(ctx, req.(*AuthGetUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_AuthGetUser_Handler,
		},
	},
