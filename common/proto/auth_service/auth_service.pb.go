...
var file_auth_service_proto_goTypes = []interface{}{
	(AuthUser_UserType)(0),                  // 0: user.AuthUser.UserType
...
var file_auth_service_proto_depIdxs = []int32{
	...
	9, // 2: user.AuthUpdateUserRequest.user:type_name -> user.AuthUser
	9, // 3: user.AuthUpdateUserResponse.user:type_name -> user.AuthUser
	0, // 4: user.AuthUser.userType:type_name -> user.AuthUser.UserType
