...
const (
	...
	AccommodationService_GetByHostId_FullMethodName                  = "/accommodation.AccommodationService/GetByHostId"
	...
	AccommodationService_DefineCustomPrice_FullMethodName            = "/accommodation.AccommodationService/DefineCustomPrice"
	AccommodationService_DeleteAccommodationsByHostId_FullMethodName = "/accommodation.AccommodationService/DeleteAccommodationsByHostId"
	AccommodationService_GetHostId_FullMethodName                    = "/accommodation.AccommodationService/GetHostId"
)
...
func (c *accommodationServiceClient) GetByHostId(ctx context.Context, in *GetByHostIdRequest, opts ...grpc.CallOption) (*GetByHostIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, AccommodationService_GetByHostId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accommodationServiceClient) DefineCustomPrice(ctx context.Context, in *DefineCustomPriceRequest, opts ...grpc.CallOption) (*DefineCustomPriceResponse, error) {
	out := new(DefineCustomPriceResponse)
	err := c.cc.Invoke(ctx, AccommodationService_DefineCustomPrice_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accommodationServiceClient) DeleteAccommodationsByHostId(ctx context.Context, in *DeleteAccommodationsByHostIdRequest, opts ...grpc.CallOption) (*DeleteAccommodationsByHostIdResponse, error) {
	out := new(DeleteAccommodationsByHostIdResponse)
	err := c.cc.Invoke(ctx, AccommodationService_DeleteAccommodationsByHostId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accommodationServiceClient) GetHostId(ctx context.Context, in *GetMessageHostReguest, opts ...grpc.CallOption) (*GetMessageHostResponse, error) {
	...
	err := c.cc.Invoke(ctx, AccommodationService_GetHostId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAccommodationServiceServer) DefineCustomPrice(context.Context, *DefineCustomPriceRequest) (*DefineCustomPriceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DefineCustomPrice not implemented")
}
...
func _AccommodationService_GetByHostId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccommodationService_GetByHostId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccommodationService_DefineCustomPrice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DefineCustomPriceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccommodationServiceServer).DefineCustomPrice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccommodationService_DefineCustomPrice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccommodationServiceServer).DefineCustomPrice(ctx, req.(*DefineCustomPriceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AccommodationService_DeleteAccommodationsByHostId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccommodationService_DeleteAccommodationsByHostId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccommodationService_GetHostId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccommodationService_GetHostId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var AccommodationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DefineCustomPrice",
			Handler:    _AccommodationService_DefineCustomPrice_Handler,
		},
		{
