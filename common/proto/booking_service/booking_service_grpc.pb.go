...
const (
	...
	BookingService_DeleteBookingsByGuestId_FullMethodName             = "/booking.BookingService/DeleteBookingsByGuestId"
	BookingService_DeleteBookingsByAccommodationId_FullMethodName     = "/booking.BookingService/DeleteBookingsByAccommodationId"
	BookingService_GetByAccommodationId_FullMethodName                = "/booking.BookingService/GetByAccommodationId"
	BookingService_GetBookingByAccommodationAndGuestId_FullMethodName = "/booking.BookingService/GetBookingByAccommodationAndGuestId"
	BookingService_GetCancellationRateForHost_FullMethodName          = "/booking.BookingService/GetCancellationRateForHost"
	BookingService_GetNumberPastBookingsForHost_FullMethodName        = "/booking.BookingService/GetNumberPastBookingsForHost"
)
...
type BookingServiceClient interface {
	...
	GetCancellationRateForHost(ctx context.Context, in *GetCancellationRateForHostRequest, opts ...grpc.CallOption) (*GetCancellationRateForHostResponse, error)
	GetNumberPastBookingsForHost(ctx context.Context, in *GetNumberPastBookingsForHostRequest, opts ...grpc.CallOption) (*GetNumberPastBookingsForHostResponse, error)
}
...
func (c *bookingServiceClient) DeleteBookingsByGuestId(ctx context.Context, in *DeleteBookingByGuestIdRequest, opts ...grpc.CallOption) (*DeleteBookingByGuestIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, BookingService_DeleteBookingsByGuestId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookingServiceClient) DeleteBookingsByAccommodationId(ctx context.Context, in *DeleteBookingByAccommodationIdRequest, opts ...grpc.CallOption) (*DeleteBookingByAccommodationIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, BookingService_DeleteBookingsByAccommodationId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookingServiceClient) GetByAccommodationId(ctx context.Context, in *GetByAccommodationIdRequest, opts ...grpc.CallOption) (*GetByAccommodationIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, BookingService_GetByAccommodationId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookingServiceClient) GetBookingByAccommodationAndGuestId(ctx context.Context, in *GetBookingByAccommodationAndGuestIdRequest, opts ...grpc.CallOption) (*GetBookingByAccommodationAndGuestIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, BookingService_GetBookingByAccommodationAndGuestId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookingServiceClient) GetCancellationRateForHost(ctx context.Context, in *GetCancellationRateForHostRequest, opts ...grpc.CallOption) (*GetCancellationRateForHostResponse, error) {
	out := new(GetCancellationRateForHostResponse)
	err := c.cc.Invoke(ctx, BookingService_GetCancellationRateForHost_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookingServiceClient) GetNumberPastBookingsForHost(ctx context.Context, in *GetNumberPastBookingsForHostRequest, opts ...grpc.CallOption) (*GetNumberPastBookingsForHostResponse, error) {
	out := new(GetNumberPastBookingsForHostResponse)
	err := c.cc.Invoke(ctx, BookingService_GetNumberPastBookingsForHost_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BookingServiceServer interface {
	...
	GetCancellationRateForHost(context.Context, *GetCancellationRateForHostRequest) (*GetCancellationRateForHostResponse, error)
	GetNumberPastBookingsForHost(context.Context, *GetNumberPastBookingsForHostRequest) (*GetNumberPastBookingsForHostResponse, error)
...
func (UnimplementedBookingServiceServer) GetCancellationRateForHost(context.Context, *GetCancellationRateForHostRequest) (*GetCancellationRateForHostResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCancellationRateForHost not implemented")
}
func (UnimplementedBookingServiceServer) GetNumberPastBookingsForHost(context.Context, *GetNumberPastBookingsForHostRequest) (*GetNumberPastBookingsForHostResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetNumberPastBookingsForHost not implemented")
}
...
func _BookingService_DeleteBookingsByGuestId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookingService_DeleteBookingsByGuestId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BookingService_DeleteBookingsByAccommodationId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookingService_DeleteBookingsByAccommodationId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BookingService_GetByAccommodationId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookingService_GetByAccommodationId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BookingService_GetBookingByAccommodationAndGuestId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookingService_GetBookingByAccommodationAndGuestId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BookingService_GetCancellationRateForHost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCancellationRateForHostRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookingServiceServer).GetCancellationRateForHost(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookingService_GetCancellationRateForHost_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookingServiceServer).GetCancellationRateForHost(ctx, req.(*GetCancellationRateForHostRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _BookingService_GetNumberPastBookingsForHost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetNumberPastBookingsForHostRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookingServiceServer).GetNumberPastBookingsForHost(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookingService_GetNumberPastBookingsForHost_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookingServiceServer).GetNumberPastBookingsForHost(ctx, req.(*GetNumberPastBookingsForHostRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BookingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetCancellationRateForHost",
			Handler:    _BookingService_GetCancellationRateForHost_Handler,
		},
		{
			MethodName: "GetNumberPastBookingsForHost",
			Handler:    _BookingService_GetNumberPastBookingsForHost_Handler,
		},
	},
